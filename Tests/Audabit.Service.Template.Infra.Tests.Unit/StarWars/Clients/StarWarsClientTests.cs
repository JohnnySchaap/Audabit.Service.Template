...
{
    public class StarWarsClientTestsBase
    {
        ...
        protected readonly StarWarsClient _starWarsClient;

        public StarWarsClientTestsBase()
        {
            ...
            _httpClientFactory.CreateClient(nameof(StarWarsClient)).Returns(_httpClient);
            _starWarsClient = new StarWarsClient(_httpClientFactory, _mapper);
        }
    }

    public class GetPersonAsync : StarWarsClientTestsBase
    {
        [Theory, AutoData]
